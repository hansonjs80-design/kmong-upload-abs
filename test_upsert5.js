...
async function test() {
  const payload1 = {
    year: 2026, month: 4, week_index: 4, day_index: 3, row_index: 30, col_index: 0, content: 'Test 30', merge_span: undefined
  };
  const payload2 = {
    year: 2026, month: 5, week_index: 0, day_index: 3, row_index: 30, col_index: 0, content: 'Test 30'
  };
